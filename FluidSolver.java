...
/*
 * -Daryl speaking-
 * Fluid dynamics are hard. Even Mr. Brooks doesn't quite know how to 
 * implement them. Thankfully, I was able to find a demo of the Navier-Stokes
 * equations from some people at CalTech. The demo was found at the following URL:
 * www.multires.caltech.edu/teaching/demos/java/stablefluids.htm
 * Their code was modified to fit within our project. Original comments are left
 * in for clarity.
 * -end Daryl's comment-
 *
 * FluidSolver.java
...
public class FluidSolver
{
     ...
     *
     * In this simplified implementation, we say that the temperature
